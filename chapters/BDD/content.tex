...
%            ymin = 0, ymax = 2.5,
  ...
  \end{subfigure}
  \caption[Fonctions de distribution radiale autour d'ions.]{Fonctions de distribution radiale autour des ions Li$^+$, Na$^+$, K$^+$, Cs$^+$, F$^-$, Cl$^-$, Br$^-$ et I$^-$. Les calculs MDFT (en rouge) sont comparés aux calculs de référence (en rouge).}
...
%            ymin = 0, ymax = 2.5,
  ...
  \end{subfigure}
  \caption[Polarisation radiale autour d'ions.]{Polarisation radiale autour des ions Li$^+$, Na$^+$, K$^+$, Cs$^+$, F$^-$, Cl$^-$, Br$^-$ et I$^-$. Les calculs MDFT (en rouge) sont comparés aux calculs de référence (en rouge).}
