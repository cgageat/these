...
Dans un premier temps nous avons comparé les énergies libres de solvatation calculées par MDFT et par dynamique moléculaire\cite{Horinek_rational_2009} aux valeurs expérimentales\cite{Marcus_simple_1994, Noyes_thermodynamics_1962}. Nous avons ensuite directement comparé les valeurs MDFT et dynamique moléculaire (voir figure \ref{fig:correlation_ions}).

En ce qui concerne les cations, MDFT et la dynamique moléculaire sous-estiment de plusieurs kcal.mol$^{-1}$ leurs énergies libres de solvatation. Cependant, les résultats sont en accord pour les deux méthodes, ce qui laisse penser que le champ de force n'est pas adapté à ce type d'ions.
