...
\begin{center}
    \captionsetup{type=figure}
	\fbox{\includegraphics[width=0.8\textwidth]{chapters/Applications/images/structure_proteine_mmpbsa.png}}
	\captionof{figure}[Structure 3D de la protéine BACE1.]{Structure 3D de la protéine BACE1 en commun dans tous les complexes étudiés.}
