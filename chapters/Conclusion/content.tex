...
\section{MDFT pour le \textit{drug design}}
...
% Le second projet consiste à coupler MDFT au logiciel de résolution des équations hydrodynamique, Laboetie\cite{Levesque_accounting_2013,Vanson_unexpected_2015,Asta_transient_2017}. Ce code, basé sur la méthode Lattice-Boltzmann utilise, comme MDFT, une représentation "en densité" du solvant. Une fonctionnelle, bien plus simple que celle minimisée dans MDFT, est propagée selon des règles prédéfinies.
% Il s'agit donc encore une fois d'une méthode dite "fonctionnelle". Laboetie est unique en ce qu'il peut tenir compte de la spécificité chimique pour étudier du transport dit "réactif", c'est à dire de pouvoir étudier la dynamique de particules qui peuvent s'adsorber et se désorber des surfaces. Aujourd'hui, la réactivité est introduite de defaçon très rudimentaire, au travers de constantes cinétiques d'adsorption et de désorption qui sont des inputs au code.
% On peut imaginer que ces constantes d'adsorption et désorption soient calculée depuis l'échelle moléculaire par un calcul (de binding?) MDFT.
